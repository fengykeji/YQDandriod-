...
public class WorkChengjiaoListAdapter extends BaseRecyclerAdapter<WorkDealBean.DataBeanX.DataBean> {
    public WorkChengjiaoListAdapter(Context context, int layoutId, List<WorkDealBean.DataBeanX.DataBean> data) {
