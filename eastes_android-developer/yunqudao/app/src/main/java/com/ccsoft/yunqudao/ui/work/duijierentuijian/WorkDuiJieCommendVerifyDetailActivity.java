...
public class WorkDuiJieCommendVerifyDetailActivity extends AppCompatActivity {
...
//        id = bundle.getInt("id");
    ...
    private void initData() {
        ...
        OkHttpUtils.get(AppConstants.URL+"agent/work/broker/waitConfirmDetail")
                .tag(this)
    ...
    public void showItemsDialogFragment() {
        ...
        itemsDialogFragment.show("", items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        Intent intent = new Intent(WorkDuiJieCommendVerifyDetailActivity.this,DuiJieQueRenActivity.class);
                        ...
                        break;
                    case 1:
                        Intent intent1 = new Intent(WorkDuiJieCommendVerifyDetailActivity.this,WeiDaoFangActivity.class);
