...
public class WorkSecondBaoBeiActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_secong_baobei);
    ...
    private void initView() {
        ...
        fragments.add(new WorkSecondBaoBeiDisableFragment());
        fragments.add(new WorkSecondBaoBeiComplainFragment());
    ...
    private void initListener() {
        mWork_button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WorkSecondBaoBeiActivity.this, HomeActivity.class);
