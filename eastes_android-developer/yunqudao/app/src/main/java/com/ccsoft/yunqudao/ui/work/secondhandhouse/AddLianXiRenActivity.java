...
public class AddLianXiRenActivity extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemSelectedListener,OptionPicker.OnOptionSelectListener{


//    protected void onCreate(@Nullable Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        ActivityManager.getInstance().addActivity(this);
//        setContentView(R.layout.activity_addlainxiren);
...
//    }
    ...
    private Spinner mCustomers_spinner_sex,customers_spinner_card_type1;
    ...
    private EditText    mCustomers_edittext_address3;
    ...
    private void initView() {
        ...
        customers_spinner_card_type1 = findViewById(R.id.customers_spinner_card_type1);
        ...
        customers_spinner_card_type1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                String[] data = getResources().getStringArray(R.array.与业主关系);
                reporter_type = data[i];
            }
...
//                AddCustomers2Activity.start(AddCustomers1Activity.this);
                ...
                Intent intent = new Intent(AddLianXiRenActivity.this,AddCustomers2Activity.class);
                ...
                if(peizhiBean.getData()!=null){
                    for (PeizhiBean.DataBean._$30Bean.ParamBeanXXXXXXXXXXXXXXXXXXXXXXXXXXXXX data : peizhiBean.getData().get_$30().getParam()) {
                        if(data.getParam().equals(reporter_type)){
                            reporter = data.getId();
                        }
                    }
                }
...
//                startActivity(intent);
    ...
    private void addLianXiRen(){
        Log.e("ccccc",house_id+" "+mName+" "+mCustomers_edittext_tel.getText().toString()
        +" "+type+" "+reporter+" "+mCustomers_edittext_card_id.getText().toString()+" "+
                mCustomers_edittext_address3.getText().toString());
        OkHttpUtils.post(HttpAdress.surveyAddContact)
                .tag(this)
                .params("house_id",house_id)
                .params("name",mName)
                .params("tel",mCustomers_edittext_tel.getText().toString())
                .params("sex",type)
                .params("report_type",reporter)
                .params("card_type",17)
                .params("card_id",mCustomers_edittext_card_id.getText().toString())
                .params("address",mCustomers_edittext_address3.getText().toString())
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        Toast.makeText(AddLianXiRenActivity.this,bean.getMsg(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
