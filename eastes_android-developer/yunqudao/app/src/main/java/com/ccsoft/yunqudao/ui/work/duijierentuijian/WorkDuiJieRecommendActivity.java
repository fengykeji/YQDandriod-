...
public class WorkDuiJieRecommendActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_tuijian);
        initView();
        initListener();
    }
    ...
    private void initView() {
        ...
        fragments.add(new WorkDuiJieRecommendVerifyFragment());
        fragments.add(new WorkDuiJieRecommendValidFragment());
        fragments.add(new WorkDuiJieRecommendDisableFragment());
        fragments.add(new WorkDuiJieRecommendComplainFragment());
    ...
    private void initListener() {
        mWork_button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WorkDuiJieRecommendActivity.this, HomeActivity.class);
