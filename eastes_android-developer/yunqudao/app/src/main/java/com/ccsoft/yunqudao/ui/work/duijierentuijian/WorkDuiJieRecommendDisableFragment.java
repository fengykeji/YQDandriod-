...
import com.ccsoft.yunqudao.ui.adapter.WorkDuiJieRecommendDisableAdapter;
...
public class WorkDuiJieRecommendDisableFragment extends Fragment implements View.OnClickListener ,OnRefreshListener {

    private View mView;
    private WorkRecommendDisableFragment mWorkRecommendDisableFragment;
    private RecyclerView mWork_recyclerview_disable;
    private WorkDuiJieRecommendDisableAdapter mAdapter;
    private List<duijeiwuxiaobean.DataBeanX.DataBean> dataList = new ArrayList<>();
    ...
    private void initView() {
        ...
        mAdapter = new WorkDuiJieRecommendDisableAdapter(getContext(),R.layout.item_work_value, dataList);
    ...
    private void initListener() {
        mAdapter.setOnItemClickListner(new BaseRecyclerAdapter.OnItemClickListner() {
            ...
            public void onItemClickListner(View v, int position) {
                ...
                Intent intent = new Intent(getActivity(),WrokDuiJieCommendDisableDetailsActivity.class);
                intent.putExtra("id",dataList.get(position).getClient_id());
...
//        });
        ...
        OkHttpUtils.get(AppConstants.URL+"agent/work/butter/disabled")
                .tag(this)
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (code == 200 && data1 != null) {
                            duijeiwuxiaobean.DataBeanX brokerWaitConfirmData = JsonUtil.jsonToEntity(data1, duijeiwuxiaobean.DataBeanX.class);
    ...
    private void loadNextData() {
        OkHttpUtils.get(AppConstants.URL+"agent/work/butter/disabled/list")
                .tag(getActivity())
                .params("page", curPage)
                .execute(new StringCallback() {
                    @Override
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (code == 200 && data != null) {
                            curPage++;
                            duijeiwuxiaobean.DataBeanX brokerWaitConfirmData = JsonUtil.jsonToEntity(data, duijeiwuxiaobean.DataBeanX.class);
                            dataList.addAll(brokerWaitConfirmData.getData());
                            mAdapter.notifyDataSetChanged();
                        }
