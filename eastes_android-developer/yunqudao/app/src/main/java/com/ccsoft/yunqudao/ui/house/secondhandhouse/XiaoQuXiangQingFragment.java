...
import com.ccsoft.yunqudao.ui.house.PoiOverlay;
import com.ccsoft.yunqudao.ui.house.ProjectDongLieBiaoActivity;
import com.ccsoft.yunqudao.ui.house.ProjectDongTaiXiangQingActivity;
import com.ccsoft.yunqudao.ui.house.ProjectHuXingXiangQingActivity;
import com.ccsoft.yunqudao.ui.house.ProjectJiChuXinXiActivity;
import com.ccsoft.yunqudao.ui.house.ProjectLouDongXiangQingActivity;
import com.ccsoft.yunqudao.ui.house.ProjectPiPeiKeHuActivity;
...
public class XiaoQuXiangQingFragment extends Fragment implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private TextView tv_fabufangyuan;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.activity_xiaoquxiangqing, container, false);
...
//        mHouse_imageview_项目图册 = mView.findViewById(R.id.house_imageview_项目图册);
        ...
        tv_fabufangyuan = mView.findViewById(R.id.tv_fabufangyuan);
    ...
    private void initListener() {
        ...
        this.tv_fabufangyuan.setOnClickListener(this);
...
//                break;
            ...
            case R.id.house_button_查看全部项目动态:
                ...
                break;
            case R.id.tv_fabufangyuan:
                Intent intent6 = new Intent(getContext(),ProjectLouDongXiangQingActivity.class);
                intent6.putExtra("project_id",project_id);
                if(!bean.getProject_basic_info().getTotal_float_url_panorama().equals("")){
                    intent6.putExtra("panorama",bean.getProject_basic_info().getTotal_float_url_panorama());
                }else {
                    intent6.putExtra("phone",bean.getProject_basic_info().getTotal_float_url_phone());
                }
...
//
    ...
    private void initData(){
        ...
        OkHttpUtils.get(HttpAdress.xiaoquHouseDetail)
                .tag(getActivity())
                .params("project_id",project_id)
