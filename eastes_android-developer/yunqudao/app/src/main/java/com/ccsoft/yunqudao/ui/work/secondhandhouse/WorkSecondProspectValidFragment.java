...
public class WorkSecondProspectValidFragment extends Fragment implements View.OnClickListener , OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.fragment_work_second_propect_kcz, container, false);
