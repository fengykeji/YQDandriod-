...
public class RenZhengXinXiShenHeZhongActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, RenZhengXinXiShenHeZhongActivity.class);
