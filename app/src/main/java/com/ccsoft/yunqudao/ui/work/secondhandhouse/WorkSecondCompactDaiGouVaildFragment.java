...
public class WorkSecondCompactDaiGouVaildFragment extends Fragment implements View.OnClickListener,OnRefreshListener {
    ...
    private void initListener() {
        adapter.setOnItemClickListner(new BaseRecyclerAdapter.OnItemClickListner() {
            ...
            public void onItemClickListner(View v, int position) {
                Intent intent = new Intent(getContext(),WorkSecondCompactDaiGouVaildDetailActivity.class);
