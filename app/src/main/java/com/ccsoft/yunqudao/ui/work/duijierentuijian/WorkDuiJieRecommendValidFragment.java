...
import com.ccsoft.yunqudao.ui.adapter.WorkDuiJieRecommendValidAdapter;
...
public class WorkDuiJieRecommendValidFragment extends Fragment implements View.OnClickListener , OnRefreshListener {
    private View mView;
    ...
    private WorkDuiJieRecommendValidAdapter mAdapter;

    private List<duijieyouxiaobean.DataBeanX.DataBean> dataList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.fragment_work_tuijian_yx, container, false);
    ...
    private void initView() {
        ...
        mAdapter = new WorkDuiJieRecommendValidAdapter(getContext(),R.layout.item_work_value, dataList);
    ...
    private void initListener() {
        mAdapter.setOnItemClickListner(new BaseRecyclerAdapter.OnItemClickListner() {
            ...
            public void onItemClickListner(View v, int position) {
                WorkDuiJieCommendValidDetailActivity.start(getActivity(), dataList.get(position).getClient_id());
            }
        });
...
//        });
        ...
        OkHttpUtils.get(AppConstants.URL+"agent/work/butter/value")
                .tag(this)
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (code == 200 && data1 != null) {
                            duijieyouxiaobean.DataBeanX brokerWaitConfirmData = JsonUtil.jsonToEntity(data1, duijieyouxiaobean.DataBeanX.class);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (code == 200 && data != null) {
                            curPage++;
                            duijieyouxiaobean.DataBeanX brokerWaitConfirmData = JsonUtil.jsonToEntity(data, duijieyouxiaobean.DataBeanX.class);
                            dataList.addAll(brokerWaitConfirmData.getData());
                            mAdapter.notifyDataSetChanged();
                        }
