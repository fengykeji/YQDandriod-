...
import com.ccsoft.yunqudao.ui.house.secondhandhouse.XiaoQuhouseActivity;
...
//    private View tvXiaoQuResource;
//    private View tvAllResource;
    private TabLayout tlHouseType;
    private ViewPager vpHouseType;
...
//        tvXiaoQuResource = mView.findViewById(R.id.tv_xiaoqu_resource);
//        tvAllResource = mView.findViewById(R.id.tv_all_resource);
        tlHouseType = mView.findViewById(R.id.tl_houseType);
        vpHouseType = mView.findViewById(R.id.vp_houseType);
        ...
        rvList.addOnScrollListener(endlessRecyclerOnScrollListener);
    }
...
//        tvXiaoQuResource.setOnClickListener(this);
//        tvAllResource.setOnClickListener(this);
        this.mCustomers_swiperefreshlayout.setOnRefreshListener(this);
//        mCustomers_swiperefreshlayout.setOnLoadmoreListener(new OnLoadmoreListener() {
//            @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_xiaoqu_resource:
                Intent intentToXiaoQuList = new Intent(getContext(),XiaoQuhouseActivity.class);
                intentToXiaoQuList.putExtra("city_code",city_code);
                startActivity(intentToXiaoQuList);
                break;
            case R.id.tv_all_resource:
                break;
        }
    }
