...
public class WorkSecondProspectActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_secong_prospect);
    ...
    private void initView() {
        ...
        fragments.add(new WorkSecondProspectVerfyFragment());
        fragments.add(new WorkSecondProspectValidFragment());
        fragments.add(new WorkSecondProspectDisableFragment());
        fragments.add(new WorkSecondProspectComplainFragment());
        fragments.add(new WorkSecondProspectFinishFragment());
    ...
    private void initListener() {
        mWork_button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WorkSecondProspectActivity.this, HomeActivity.class);
